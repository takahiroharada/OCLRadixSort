...
__kernel
__attribute__((reqd_work_group_size(128,1,1)))
void PrefixScan16PerWiKernel( __global u32* wHistogram1, int m_nWGs )
{
	__local u32 ldsTopScanData[128*2];

	const int nPerLane = (nPerWI/4);
...
__kernel
__attribute__((reqd_work_group_size(128,1,1)))
void PrefixScan32PerWiKernel( __global u32* wHistogram1, int m_nWGs )
{
	__local u32 ldsTopScanData[128*2];
...
__kernel
__attribute__((reqd_work_group_size(WG_SIZE,1,1)))
void SortAndScatterKernel( __global const u32* restrict gSrc, __global const u32* rHistogram, __global u32* restrict gDst,
                          int m_n, int m_nWGs, int m_startBit, int m_nBlocksPerWG)
{
